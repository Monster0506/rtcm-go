...
func TestDecodeMsg1020(t *testing.T) {
	...
	checkFloat(t, "TbMin", m.TbMin, 1185, 1e-9)
	checkFloat(t, "XnFirstDerivativeKmPerS", m.XnFirstDerivativeKmPerS, -2.059713363647461, 1e-9)
	checkFloat(t, "XnKm", m.XnKm, 19637.81884765625, 1e-9)
	checkFloat(t, "XnSecondDerivativeKmPerS2", m.XnSecondDerivativeKmPerS2, 0.0, 1e-9)
	checkFloat(t, "YnFirstDerivativeKmPerS", m.YnFirstDerivativeKmPerS, 0.8449039459228516, 1e-9)
	checkFloat(t, "YnKm", m.YnKm, 33.10888671875, 1e-9)
	checkFloat(t, "YnSecondDerivativeKmPerS2", m.YnSecondDerivativeKmPerS2, -1.862645149230957e-09, 1e-9)
	checkFloat(t, "ZnFirstDerivativeKmPerS", m.ZnFirstDerivativeKmPerS, -2.4976272583007812, 1e-9)
	checkFloat(t, "ZnKm", m.ZnKm, -16217.08740234375, 1e-9)
	checkFloat(t, "ZnSecondDerivativeKmPerS2", m.ZnSecondDerivativeKmPerS2, 2.7939677238464355e-09, 1e-9)
	checkFloat(t, "GammaN", m.GammaN, 1.8189894035458565e-12, 1e-9)
	checkFloat(t, "TauNS", m.TauNS, -0.00017513707280158997, 1e-9)
	checkFloat(t, "MDeltaTauS", m.MDeltaTauS, -3.725290298461914e-09, 1e-9)
	checkFloat(t, "TauCS", m.TauCS, -1.3969838619232178e-09, 1e-9)
	checkFloat(t, "MTauGPSS", m.MTauGPSS, 7.450580596923828e-09, 1e-9)
}
