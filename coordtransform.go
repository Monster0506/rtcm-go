...
func decodeCoordTransformCommon(r *BitReader) CoordTransformCommon {
	var c CoordTransformCommon
	c.MessageType = int(r.ReadUint(12))
	c.SourceName = readLengthPrefixedStringN(r, 5)
	c.TargetName = readLengthPrefixedStringN(r, 5)
...
func decodeCoordTransformTail(r *BitReader) CoordTransformTail {
