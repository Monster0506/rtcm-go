...
func TestDecodeMsg1012(t *testing.T) {
	...
	checkFloat(t, "Satellites[0].L2MinusL1PseudorangeM", s0.L2MinusL1PseudorangeM, 15.06, 1e-6)
	checkFloat(t, "Satellites[0].L2PhaserangeM", s0.L2PhaserangeM, 19.2865, 1e-6)
	if s0.L2LockTimeIndicator != 105 {
		t.Fatalf("Satellites[0].L2LockTimeIndicator = %d, want 105", s0.L2LockTimeIndicator)
	}
	checkFloat(t, "Satellites[0].L2CNRDbHz", s0.L2CNRDbHz, 35.5, 1e-6)
}
