...
func TestDecodeMsg1025(t *testing.T) {
	...
	checkFloat(t, "LatitudeOfNaturalOriginDeg", m.LatitudeOfNaturalOriginDeg, 11.0, 1e-9)
	checkFloat(t, "LongitudeOfNaturalOriginDeg", m.LongitudeOfNaturalOriginDeg, -22.0, 1e-9)
	checkFloat(t, "AddScaleFactorPPM", m.AddScaleFactorPPM, 7.000000000000001, 1e-9)
	checkFloat(t, "FalseEastingM", m.FalseEastingM, 50000.0, 1e-9)
	checkFloat(t, "FalseNorthingM", m.FalseNorthingM, -30000.0, 1e-9)
}
