...
func TestDecodeMsg1046(t *testing.T) {
	...
	checkFloat(t, "IDOTSemiCirclesPerS", m.IDOTSemiCirclesPerS, -3.1377567211166024e-11, 1e-9)
	checkFloat(t, "TocS", m.TocS, 318000, 1e-9)
	checkFloat(t, "Af2SPerS2", m.Af2SPerS2, 0.0, 1e-9)
	checkFloat(t, "Af1SPerS", m.Af1SPerS, 3.552713678800501e-12, 1e-9)
	checkFloat(t, "Af0S", m.Af0S, 0.004728707484900951, 1e-9)
	checkFloat(t, "CrsM", m.CrsM, -44.1875, 1e-9)
	checkFloat(t, "DeltaNSemiCirclesPerS", m.DeltaNSemiCirclesPerS, 1.169496499642264e-09, 1e-9)
	checkFloat(t, "M0SemiCircles", m.M0SemiCircles, 0.06877923710271716, 1e-9)
	checkFloat(t, "CucRad", m.CucRad, -1.9818544387817383e-06, 1e-9)
	checkFloat(t, "Eccentricity", m.Eccentricity, 0.00023969111498445272, 1e-9)
	checkFloat(t, "CusRad", m.CusRad, 4.159286618232727e-06, 1e-9)
	checkFloat(t, "SqrtA", m.SqrtA, 5440.592296600342, 1e-9)
	checkFloat(t, "ToeS", m.ToeS, 318000, 1e-9)
	checkFloat(t, "CicRad", m.CicRad, -5.587935447692871e-09, 1e-9)
	checkFloat(t, "Omega0SemiCircles", m.Omega0SemiCircles, -0.24508378840982914, 1e-9)
	checkFloat(t, "CisRad", m.CisRad, -5.587935447692871e-09, 1e-9)
	checkFloat(t, "I0SemiCircles", m.I0SemiCircles, 0.30577638652175665, 1e-9)
	checkFloat(t, "CrcM", m.CrcM, 248.15625, 1e-9)
	checkFloat(t, "OmegaSemiCircles", m.OmegaSemiCircles, -0.446898490190506, 1e-9)
	checkFloat(t, "OmegaDotSemiCirclesPerS", m.OmegaDotSemiCirclesPerS, -1.8883383745560423e-09, 1e-9)
	checkFloat(t, "BGDE5aE1S", m.BGDE5aE1S, 4.423782229423523e-09, 1e-9)
	checkFloat(t, "BGDE5bE1S", m.BGDE5bE1S, 4.889443516731262e-09, 1e-9)
}
