...
func decodeSSRHeader(r *core.BitReader, epochBits int) SSRHeader {
	var h SSRHeader
...
func decodeSSROrbitHeader(r *core.BitReader, epochBits int) SSROrbitHeader {
...
func decodeSSROrbitCorrection(r *core.BitReader, satIDBits int) SSROrbitCorrection {
...
func decodeSSRClockCorrection(r *core.BitReader, satIDBits int) SSRClockCorrection {
...
func decodeSSRSatelliteCodeBiases(r *core.BitReader, satIDBits int) SSRSatelliteCodeBiases {
...
func decodeSSRURA(r *core.BitReader, satIDBits int) SSRURA {
	var u SSRURA
...
func decodeSSRCombinedCorrection(r *core.BitReader, satIDBits int) SSRCombinedCorrection {
...
func decodeSSRHighRateClock(r *core.BitReader, satIDBits int) SSRHighRateClock {
