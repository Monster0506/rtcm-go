...
func TestDecodeMsg1027(t *testing.T) {
	...
	testutil.CheckFloat(t, "LatitudeOfProjectionCenterDeg", m.LatitudeOfProjectionCenterDeg, 11.0, 1e-9)
	testutil.CheckFloat(t, "LongitudeOfProjectionCenterDeg", m.LongitudeOfProjectionCenterDeg, -22.0, 1e-9)
	testutil.CheckFloat(t, "AzimuthOfInitialLineDeg", m.AzimuthOfInitialLineDeg, 165.0, 1e-9)
	testutil.CheckFloat(t, "DiffAngleRectifiedToSkewGridDeg", m.DiffAngleRectifiedToSkewGridDeg, -0.0055, 1e-9)
	testutil.CheckFloat(t, "AddScaleFactorPPM", m.AddScaleFactorPPM, 7.000000000000001, 1e-9)
	testutil.CheckFloat(t, "EastingAtProjectionCenterM", m.EastingAtProjectionCenterM, 50000.0, 1e-9)
	testutil.CheckFloat(t, "NorthingAtProjectionCenterM", m.NorthingAtProjectionCenterM, -30000.0, 1e-9)
}
