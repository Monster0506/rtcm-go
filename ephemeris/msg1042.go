...
func DecodeMsg1042(payload []byte) (*Msg1042, error) {
	...
	m.A2SPerS2 = float64(r.ReadInt(11)) * core.TwoPow(-66)
	m.A1SPerS = float64(r.ReadInt(22)) * core.TwoPow(-50)
	m.A0S = float64(r.ReadInt(24)) * core.TwoPow(-33)
	m.AODC = int(r.ReadUint(5))
	m.CrsM = float64(r.ReadInt(18)) * core.TwoPow(-6)
	m.DeltaNSemiCirclesPerS = float64(r.ReadInt(16)) * core.TwoPow(-43)
	m.M0SemiCircles = float64(r.ReadInt(32)) * core.TwoPow(-31)
	m.CucRad = float64(r.ReadInt(18)) * core.TwoPow(-31)
	m.Eccentricity = float64(r.ReadUint(32)) * core.TwoPow(-33)
	m.CusRad = float64(r.ReadInt(18)) * core.TwoPow(-31)
	m.SqrtA = float64(r.ReadUint(32)) * core.TwoPow(-19)
	m.ToeS = float64(r.ReadUint(17)) * 8
	m.CicRad = float64(r.ReadInt(18)) * core.TwoPow(-31)
	m.Omega0SemiCircles = float64(r.ReadInt(32)) * core.TwoPow(-31)
	m.CisRad = float64(r.ReadInt(18)) * core.TwoPow(-31)
	m.I0SemiCircles = float64(r.ReadInt(32)) * core.TwoPow(-31)
	m.CrcM = float64(r.ReadInt(18)) * core.TwoPow(-6)
