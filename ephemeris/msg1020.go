...
func DecodeMsg1020(payload []byte) (*Msg1020, error) {
	...
	m.XnFirstDerivativeKmPerS = float64(r.ReadSignMagnitude(24)) * core.TwoPow(-20)
	m.XnKm = float64(r.ReadSignMagnitude(27)) * core.TwoPow(-11)
	m.XnSecondDerivativeKmPerS2 = float64(r.ReadSignMagnitude(5)) * core.TwoPow(-30)
	m.YnFirstDerivativeKmPerS = float64(r.ReadSignMagnitude(24)) * core.TwoPow(-20)
	m.YnKm = float64(r.ReadSignMagnitude(27)) * core.TwoPow(-11)
	m.YnSecondDerivativeKmPerS2 = float64(r.ReadSignMagnitude(5)) * core.TwoPow(-30)
	m.ZnFirstDerivativeKmPerS = float64(r.ReadSignMagnitude(24)) * core.TwoPow(-20)
	m.ZnKm = float64(r.ReadSignMagnitude(27)) * core.TwoPow(-11)
	m.ZnSecondDerivativeKmPerS2 = float64(r.ReadSignMagnitude(5)) * core.TwoPow(-30)
	m.P3 = r.ReadUint(1) != 0
	m.GammaN = float64(r.ReadSignMagnitude(11)) * core.TwoPow(-40)
	m.MP = int(r.ReadUint(2))
	m.MLn3rdString = r.ReadUint(1) != 0
	m.TauNS = float64(r.ReadSignMagnitude(22)) * core.TwoPow(-30)
	m.MDeltaTauS = float64(r.ReadSignMagnitude(5)) * core.TwoPow(-30)
	...
	m.TauCS = float64(r.ReadSignMagnitude(32)) * core.TwoPow(-31)
	m.MN4 = int(r.ReadUint(5))
	m.MTauGPSS = float64(r.ReadSignMagnitude(22)) * core.TwoPow(-30)
