...
func decodeGPSObservationHeader(r *BitReader) (GPSObservationHeader, int) {
...
func decodeGPSL1Observation(r *BitReader) GPSL1Observation {
...
func decodeGPSL1ExtendedObservation(r *BitReader) GPSL1ExtendedObservation {
...
func decodeGPSL2Observation(r *BitReader) GPSL2Observation {
...
func decodeGPSL2ExtendedObservation(r *BitReader) GPSL2ExtendedObservation {
