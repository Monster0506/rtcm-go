...
func TestDecodeMsg1006(t *testing.T) {
	...
	testutil.CheckFloat(t, "ECEFXM", msg.ECEFXM, 1762489.6191, tol)
	testutil.CheckFloat(t, "ECEFYM", msg.ECEFYM, -5027633.8438, tol)
	testutil.CheckFloat(t, "ECEFZM", msg.ECEFZM, -3496008.8438000004, tol)
	testutil.CheckFloat(t, "AntennaHeightM", msg.AntennaHeightM, 0.034300000000000004, tol)
}
