...
func TestDecodeMsg1005(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			payload, _, err := core.ParseFrame(tt.frame)
			if err != nil {
			...
			testutil.CheckFloat(t, "ECEFXM", msg.ECEFXM, tt.wantECEFXM, tol)
			testutil.CheckFloat(t, "ECEFYM", msg.ECEFYM, tt.wantECEFYM, tol)
			testutil.CheckFloat(t, "ECEFZM", msg.ECEFZM, tt.wantECEFZM, tol)
		})
	}
}
